    ...
    <body>
        ...
        <table>
            ...
            try {
                ...
                String query_empresa = "SELECT U.username, P.nombre AS nombre_proyecto FROM usuarios AS U JOIN usuarios_proyectos AS UP ON U.id_user = UP.id_user JOIN proyectos AS P ON UP.id_proyecto = P.id_proyecto WHERE U.username = ?";
                ps = conn.prepareStatement(query_empresa);
                ps.setString(1, username);
                rs = stmt.executeQuery(query_empresa);
                rs_empresa = stmt.executeQuery(query_empresa);

                while (rs.next()) {
                    String username_ = rs_empresa.getString("U.username");
                    String nombre = rs_empresa.getString("P.string");
